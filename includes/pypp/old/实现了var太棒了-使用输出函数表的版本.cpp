...
typedef ostream& (*output_func)(ostream& out, var& v);

ostream& output_func_udef(ostream& out, var& v) { return out<<"sorry, type undefiened"; }
ostream& output_func_object(ostream& out, var& v) { return out<<"sorry, this func tmp not available"; }
// ostream& output_func_schar(ostream& out, var& v) { return out<<v.schar(); }
ostream& output_func_uchar(ostream& out, var& v) { return out<<v.uchar(); }
ostream& output_func_sshort(ostream& out, var& v) { return out<<v.sshort(); }
ostream& output_func_ushort(ostream& out, var& v) { return out<<v.ushort(); }
ostream& output_func_sint(ostream& out, var& v) { return out<<v.sint(); }
ostream& output_func_uint(ostream& out, var& v) { return out<<v.uint(); }
ostream& output_func_slong(ostream& out, var& v) { return out<<v.slong(); }
ostream& output_func_ulong(ostream& out, var& v) { return out<<v.ulong(); }
ostream& output_func_float(ostream& out, var& v) { return out<<v.flt(); }
ostream& output_func_double(ostream& out, var& v) { return out<<v.dbl(); }

ostream& output_func_cstr(ostream& out, var& v) { return out<<v.str(); }
ostream& output_func_str_string(ostream& out, var& v) { return out<<v.str(); }

void* a[]={(void*)output_func_udef};
(output_func*)(a[0]);


output_func output_funcs[20]={
// /*output_funcs[vt::undef]*/		output_func_udef,
// /*output_funcs[vt::number]*/	output_func_sint,
// /*output_funcs[vt::string]*/	output_func_cstr,
// /*output_funcs[vt::charactor]*/	output_func_schar,
// /*output_funcs[vt::object]*/	output_func_object,
/*output_funcs[vt::num::sint1]*/	output_func_schar,
// /*output_funcs[vt::num::uint1]*/	output_func_uchar,
// /*output_funcs[vt::num::sint2]*/	output_func_sshort,
// /*output_funcs[vt::num::uint2]*/	output_func_ushort,
// /*output_funcs[vt::num::sint4]*/	output_func_sint,
// /*output_funcs[vt::num::uint4]*/	output_func_uint,
// /*output_funcs[vt::num::sint8]*/	output_func_slong,
// /*output_funcs[vt::num::uint8]*/	output_func_ulong,
// /*output_funcs[vt::num::real4]*/	output_func_float,
// /*output_funcs[vt::num::real8]*/	output_func_double,
// /*output_funcs[vt::str::cstr]*/		output_func_cstr,
// /*output_funcs[vt::str::string]*/	output_func_cstr,
// /*output_funcs[vt::obj::list]*/		output_func_udef,
// /*output_funcs[vt::obj::tuple]*/	output_func_udef,
// /*output_funcs[vt::obj::dict]*/		output_func_udef
};
...
public:
	...
	friend ostream& operator<<(ostream& out, var& v) {
		...
		return output_funcs[type](out, v);
		...
		if (type>=vt::num::base AND type<vt::num::end) {
			...
			if (v.type()==vt::str::cstr) out<<v.str();
